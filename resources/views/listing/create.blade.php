<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listing" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="logo_path" class="inline-block text-lg mb-2">Company Logo</label>
                <input type="file" class="border border-gray-200 rounded p-2 w-full" name="logo_path" />
                @error('logo')
                    <p class="text-red-500 text-xs mt-1">{{$logo_path}}</p>
                @enderror
            </div>
